...
export default function page() {
    ...
    return (
        <div className='w-[100%]'>
            ...
            {/*  */}
            <div className="w-full flex flex-col justify-center items-center pt-11 md:flex-row sm:px-3 md:px-11 bg-[url('/6923253.jpg')]">
                ...
                <div data-aos="fade-up" data-aos-duration="1000" className="relative z-20 w-full md:w-[50%] p-2 sm:p-6">
                    ...
                    <div class="cursor-pointer group overflow-hidden shadow-xl shadow-neutral-900 p-5 duration-1000 hover:duration-1000 relative w-full backdrop-blur-md rounded-xl">
                        ...
                        <div class="w-full h-full sm:p-3  opacity-50 rounded-xl flex-col flex justify-center" >
                            <span class="text-white font-bold text-3xl  italic">About Mahadev Studios</span>
                            <p class="text-neutral-50 justify-center">
