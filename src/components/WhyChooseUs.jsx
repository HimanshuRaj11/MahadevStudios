...
const Tags = [
    {
        icon: <FaRocket className="text-xl text-orange-400" />,
        tag: "14+ Years of Industry Experience",
        detail: "Two decades of mastering the craft."
    },
    {
        icon: <BsFillCameraReelsFill className="text-xl text-orange-400" />,
        tag: "Expertise in Film & TV Productions",
        detail: "National-level quality, every project."
    },
    {
        icon: <MdFax className="text-xl text-orange-400" />,
        tag: "Passionate Storytellers with a Vision",
        detail: "We don't just film — we tell stories."
    },
    {
        icon: <PiSpeakerSimpleHighFill className="text-xl text-orange-400" />,
        tag: "Commitment to Excellence & Client Satisfaction",
        detail: "Your vision, delivered without compromise."
    },
    {
        icon: <GiTakeMyMoney className="text-xl text-orange-400" />,
        tag: "High-Quality Production at Competitive Rates",
        detail: "Premium output, sensible pricing."
    },
]
