...
export default function Homecard() {
    return (
        ...
        <div className="card relative">
            ...
            <div className="cloud">
                <svg fill="#000000" preserveAspectRatio="xMidYMid meet" className="iconify iconify--emojione" role="img" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                    <g strokeWidth="0" id="SVGRepo_bgCarrier"></g>
                    <g strokeLinejoin="round" strokeLinecap="round" id="SVGRepo_tracerCarrier"></g>

                </svg>
            </div>
            {/* <p className="main-text">Mahadev Studios</p> */}
            <div className="info absolute bottom-4">
                <div className="info-left">
                    <p className="text-white text-3xl"> Crafting Impactful Visual Stories Since 2010</p>
                </div>
            </div>
        </div>
    )
